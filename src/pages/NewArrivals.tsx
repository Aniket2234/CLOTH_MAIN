    ...
    <div className="bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center py-20">
          ...
          <p className="text-lg text-gray-600 mb-8">Discover the latest additions to our collection</p>
          <div className="bg-gray-100 rounded-lg p-12">
            <p className="text-gray-500">New arrival products will be displayed here</p>
