...
const Shirts = () => {
  ...
  const [filteredProducts, setFilteredProducts] = useState(getProductsByCategory('shirts'));
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex gap-8">
          ...
          <div className="flex-1">
            <div className="mb-8">
              <h1 className="text-3xl font-bold text-gray-900 mb-2">Shirts</h1>
              <p className="text-gray-600">Elevate your everyday style with premium shirts</p>
            </div>
