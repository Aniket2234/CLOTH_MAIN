...
const Accessories = () => {
  ...
  const [filteredProducts, setFilteredProducts] = useState(getProductsByCategory('accessories'));
        ...
        <div className="flex gap-8">
          ...
          <div className="flex-1">
            <div className="mb-8">
              ...
              <p className="text-gray-600">Complete your style with our accessories</p>
            </div>
